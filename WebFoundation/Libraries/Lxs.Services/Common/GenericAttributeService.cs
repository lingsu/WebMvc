...
using Lxs.Core;
using Lxs.Core.Caching;
using Lxs.Core.Data;
using Lxs.Core.Domain.Common;
using Lxs.Data;

namespace Lxs.Services.Common
{
    public partial class GenericAttributeService : IGenericAttributeService
    {
        ...
        /// {1} : key group
        /// </remarks>
        private const string GENERICATTRIBUTE_KEY = "Lxs.genericattribute.{0}-{1}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string GENERICATTRIBUTE_PATTERN_KEY = "Lxs.genericattribute.";
        #endregion
